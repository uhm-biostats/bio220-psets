...
::: {.callout-tip}
## Questions 7--8 refer to the prompt and figure above

  

7. Which panel depicts the strongest positive association between $X$ and $Y$? [1 point]
...
8. Which panel depicts data that likely violate the assumptions of correlation tests? [1 point]
